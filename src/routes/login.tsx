...
export const Route = createFileRoute("/login")({
  ...
  head: () => ({
    meta: [
      { title: "Log In — Isobel" },
      { name: "description", content: "Sign in to your Isobel members account." },
    ],
  }),
  component: LoginPage,
});
    ...
    <section className="bg-brand-cream py-20 min-h-[calc(100vh-200px)]">
      <div className="container mx-auto px-6 max-w-md">
        <div className="text-center mb-10">
          ...
          <p className="text-sm text-brand-ink/60">Sign in to your Isobel account</p>
        </div>
        ...
        <div className="bg-white border border-brand-taupe p-8 md:p-10">
          <form onSubmit={handleSubmit} className="space-y-5" noValidate>
            ...
            <div className="flex flex-col items-center gap-3 pt-2">
              ...
              >
                New to Isobel? <span className="underline">Create an account</span>
              </Link>
              <button
                type="button"
